...
miki = pygame.image.load("C:/Users/Dimash/Desktop/Dimash2024PP2/lab7/mainclock2.png")
larm = pygame.image.load("C:/Users/Dimash/Desktop/Dimash2024PP2/lab7/leftarm.png")
rarm = pygame.image.load("C:/Users/Dimash/Desktop/Dimash2024PP2/lab7/rightarm.png")
done = False
...
while not done:
    ...
    minutes_angle = (current_time.minute + current_time.second / 60) * 6
